    ...
    <>
      <main className='main'>
        ...
        <section className="formInfo">
            <button className='firstBtn'><span className='spanBtn'><b>Try it free</b></span> 7 days then <br id='hidden' /> $20/mo. thereafter</button>
...
export default Component
>>>>>>> 96c541993a890c8f2c11b188b1b318807e20ea60
